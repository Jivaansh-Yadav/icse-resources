...
import { BookOpen, GraduationCap, Moon, Sun, Search, X, Brain, Info, Heart, GitCommit, Copy, ExternalLink } from "lucide-react";
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-20">
      ...
      */}
      ...
      {/* ==================== RESOURCE CARDS ==================== */}
      <div className="flex flex-col items-center gap-6 w-full max-w-2xl animate-fade-in" style={{ animationDelay: "0.15s" }}>

        {/* Top row: CISCE + Study Materials */}
        ...
        {/* --- Card 3: Interactive Quizzes (horizontal, no description) --- */}
        <div
          className="group w-full max-w-md rounded-2xl border border-border bg-card px-6 py-4 shadow-sm cursor-pointer hover:-translate-y-1 hover:shadow-lg transition-all duration-200"
        ...
        >
          <div className="flex items-center justify-center gap-3">
            ...
            <h2 className="text-base font-semibold text-foreground">Interactive Quizzes</h2>
          </div>
        </div>
      </div>
      ...
      {/* ==================== QUIZZES MODAL (iframe) ==================== */}
      {quizOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full h-full max-w-7xl max-h-[95vh] rounded-2xl border border-border bg-card shadow-2xl overflow-hidden flex flex-col">
            <div className="flex items-center justify-between px-5 py-3 border-b border-border bg-card">
              <div className="flex items-center gap-2">
                <Brain className="h-5 w-5 text-primary" />
                <h3 className="text-base font-semibold text-foreground">Interactive Quizzes</h3>
              </div>
              <button
  ...
  return (
    <>
      <footer className="fixed bottom-6 left-1/2 -translate-x-1/2 z-30 flex items-center gap-4 px-6 py-3 rounded-full bg-card/80 backdrop-blur-md shadow-lg border border-border/50">
        ...
        {/* GitHub */}
        <a href="https://github.com/Jivaansh-Yadav/class-10-icse" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full hover:bg-accent hover:scale-110 active:scale-95 transition-all" title="GitHub Repository">
          ...
          <div className="fixed z-[90] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-sm animate-scale-in">
            <div className="rounded-2xl border border-border bg-card shadow-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <a href="https://discord.gg/xGD8SnvuKX" target="_blank" rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-4 rounded-xl border border-border bg-background hover:bg-accent/40 hover:shadow-md transition-all text-center">
                  ...
                  <span className="text-sm font-medium text-foreground">ICSEcord</span>
                  <span className="text-xs text-muted-foreground">Join the ICSEcord Server on Discord. Some resources have been downloaded from this server</span>
                </a>
